...
export function SpatialFilterTab() {
  ...
  // Reset derived images when shared original changes
  useEffect(() => {
    setNoisy(null);
    setFiltered(null);
  }, [originalImage]);
  ...
  const applyNoise = useCallback(() => {
    ...
    const src = cloneImageData(originalImage);
    ...
    setNoisy(result);
    setFiltered(null);
  }, [originalImage, noiseType, noisePercent]);
  ...
  const applyFilter = useCallback(() => {
    ...
    setFiltered(result);
  }, [noisy, originalImage, filterType, kernelSize]);
